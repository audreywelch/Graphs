...
4 Parts:
    ...
    - Test code. Run the tests by typing python3 adv.py in terminal
    - REPL code. Run it and walk around the map
"""
...
world.loadGraph(roomGraph) # passing in the roomGraph
# startingRoom gets assigned in loadGraph
